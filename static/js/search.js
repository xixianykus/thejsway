...
document
  .getElementById('custom-search-field')
      ...
      if (searchword.test(searchtext) === true) {
        ...
        for (var key in searchfield_weight) {
          ...
          if (searchword.test(searchstr) === true) {
            ...
            if (key == 'tags' && tags != '')
              tags_matches = tags_matches + count;
  ...
  if (results.length >= 1) {
    ...
    for (var i = 0; i < results.length; i++) {
      ...
      if (debug != '' && debug != null) {
        ...
        var plus_title =
          title_matches >= 1 ? '+ ' + searchfield_weight['title'] : '+ 0';
        var plus_tags =
          tags_matches >= 1 ? '+ ' + searchfield_weight['tags'] : '+ 0';
        var plus_summary =
          summary_matches >= 1 ? '+ ' + searchfield_weight['summary'] : '+ 0';
        var plus_content =
          content_matches >= 1 ? '+ ' + searchfield_weight['content'] : '+ 0';

        infos += '<table style="font-size: 12px; color: #666666;">';
        infos +=
          '<tr><td style="width: 100px;"><b>Gesamt:</b></td><td style="text-align: right;">' +
          matches +
          '</td></tr>';
        infos +=
          '<tr><td>Title (' +
        ...
        infos +=
          ...
          '</td></tr>';
        infos +=
          '<tr><td><b>Gesamt neu:</b></td><td style="text-align: right;">' +
          matches_calc +
          '</td></tr>';
        infos += '</table><br>';
      }
